...
export const TRAFFIC_SESSION_KEY = "brand-my-fold-traffic-session-v1";
...
const startingPrices = [249, 249, 249, 69, 69, 69, 69, 129, 129, 129];
...
export const COPY = {
  en: {
    ...
    hero: {
      visitors: "total visitors", liveVisitors: "people visiting now", title: "Your brand, on my Fold.", subtitle: `Ten measured placements on the camera-side shell of my future ${productEn}.`,
      raised: "raised in verified leading bids", starting: "starting price", goal: "of the device target", ends: "Auction is live · closes in", unfolded: "Open view", folded: "Folded view",
      ...
      story: `Ten stickers. Fourteen days. One ${productEn} in the real world.`, story2: "A winning bid secures one finite physical placement, a linked brand listing on this page, and appearances in the campaign’s launch and everyday-use content.", howLink: "How the campaign works",
    },
    recognition: { title: "A new device attracts attention. Ten brands can become part of its first public story.", link: "View available placements", held: "of 10 spots held", live: "bidding live", status: "camera-side shell only" },
    ...
    purchase: { eyebrow: "WHAT THE BIDS FUND", title: `Enough to buy one ${productEn}.`, lead: "The 2,399 USDT target follows the current public price range for Apple’s first foldable iPhone.", name: `1 × ${productEn}, Graphite`, sub: "Final retail name and configuration follow Apple’s announcement", rows: [["Purchase",`Buy one ${productEn} when it becomes available`],["Apply","Print and fit ten approved vinyl stickers"],["Carry","Use the completed device in public for 14 days"],["Publish","Include it in launch photos, video and everyday-use updates"]], note: "The auction closes when Apple’s September 9 event begins. The 14-day placement period starts after delivery and installation." },
    faq: { eyebrow: "DETAILS", title: "Questions & Answers", items: [
      ...
      ["What do the funds buy?",`One graphite ${productEn}. The 2,399 USDT target is based on the current public price range for Apple’s first foldable iPhone; the final retail name and configuration follow Apple’s announcement.`],
      ["When does the auction close?","September 9, 2026 at 10:00 a.m. Pacific Time, when Apple’s special event begins. The countdown on this page uses that exact moment."],
    ...
    reuse: { eyebrow: "OPEN SOURCE", title: "Run this auction on your own device.", text: "The public repository contains the complete bilingual interface, placement system and Cloudflare backend pattern. Fork it, replace the product art and copy, configure your own services, and launch.", button: "Fork on GitHub", secondary: "Read the deployment guide", steps: [["Fork","Create your own copy of the repository."],["Make it yours","Replace the device, placements, campaign copy and prices."],["Deploy","Connect your Cloudflare resources and payment configuration."]] },
    globe: { eyebrow: "TRAFFIC, LIVE", title: "See who is here, right now.", lead: "Drag and zoom the globe to explore recent visitors by country, city and arrival channel. The first-party feed updates while this page is open.", loading: "Loading live visitors…", live: "live traffic", retry: "Retry traffic feed", events: "recent visitors", selected: "Recent visitor", opens: "total visitors", liveNow: "online now", instruction: "Drag · zoom · select a visitor", source: "Cloudflare location · first-party analytics", unknown: "Location unavailable", direct: "Direct" },
    footer: { hi: "Built by @sergepoliakov", bio: "An open-source campaign that turns one physical surface into ten finite media placements.", prompt: "Building your own version?", join: "Fork the source.", privacy: "Privacy", terms: "Auction terms", source: "Source code", legal: "Independent campaign. No affiliation, endorsement or sponsorship is claimed. Third-party marks remain the property of their owners." },
    modal: {
    ...
    legal: {
      ...
      privacySections: [["Auction data","We process email, brand name, optional website and X handle, selected spot, bid amount, payment network and transaction identifier."],["Artwork","PNG, JPG and WEBP artwork is stored in private object storage and reviewed before publication. Unapproved artwork is not displayed publicly."],["Visitor traffic","The live traffic view stores an anonymous browser session, approximate Cloudflare country, region and city, arrival channel, and first/last visit times. It does not store the visitor’s raw IP address."],["Blockchain records","Wallet addresses, token transfers and transaction identifiers are public blockchain data. The service verifies them against the selected network and payment quote."],["Service providers","Cloudflare provides hosting, database, object storage, approximate request location, abuse protection and logs. MapLibre and OpenFreeMap render the interactive globe."],["Open-source edition","When the production API is unavailable, local preview bids stay in the browser and are not submitted to the live auction."]],
  ...
  zh: {
    ...
    hero: {
      visitors: "累计访客", liveVisitors: "人正在浏览", title: "把你的品牌，贴上我的 Fold。", subtitle: `未来这台${productZh}的摄像头侧外壳，只有十个经过测量的广告位。`, raised: "已核验领先出价", starting: "起拍价", goal: "设备目标已完成", ends: "竞拍进行中 · 距离结束", unfolded: "展开效果", folded: "折叠效果",
      hint: "展开与折叠形态共用同一套广告位编号和位置。点击任意品牌标识，即可查看并竞拍对应广告位。", printable: "摄像头侧外壳", screen: "外屏 · 不设广告位", bid: "出价", outbid: "加价", story: `十张贴纸，十四天，一台走进真实生活的${productZh}。`, story2: "获胜出价会锁定一个有限的实体广告位、本页品牌链接，以及活动首发和日常使用内容中的公开呈现。", howLink: "了解参与方式",
    },
    recognition: { title: "一台新设备的首次亮相，会自然吸引关注。十个品牌可以进入它的第一段公开故事。", link: "查看可竞拍位置", held: "个广告位已有领先出价", live: "竞拍进行中", status: "仅限摄像头侧外壳" },
    ...
    purchase: { eyebrow: "这些资金用于什么", title: `够我买一台${productZh}。`, lead: "2,399 USDT 目标参考目前公开报道中苹果首款折叠 iPhone 的价格区间。", name: `1 × ${productZh}，石墨色`, sub: "最终零售名称与配置以苹果正式发布为准", rows: [["购买",`在正式发售后购买一台${productZh}`],["粘贴","印刷并安装十张通过审核的品牌贴纸"],["携带","带着完成后的设备公开使用 14 天"],["发布","让它出现在首发照片、视频和日常使用记录中"]], note: "竞拍会在苹果 9 月 9 日特别活动开始时结束；设备到货并完成贴纸安装后，14 天展示周期开始。" },
    faq: { eyebrow: "详细说明", title: "常见问题", items: [
      ["这里出售的是什么？","一个编号区域内为期 14 天的实体广告展示服务，同时包含本页品牌链接和活动公开内容中的呈现。竞拍者购买的不是手机本身。"],
      ["这些资金用于什么？",`购买一台石墨色${productZh}。2,399 USDT 目标参考目前公开报道中苹果首款折叠 iPhone 的价格区间；最终零售名称与配置以苹果正式发布为准。`],
      ["竞拍什么时候结束？","2026 年 9 月 9 日太平洋时间上午 10:00，也就是苹果特别活动开始的时刻。页面倒计时以这个准确时间为准。"],
    ...
    reuse: { eyebrow: "开源项目", title: "把这套竞拍，换成你自己的设备。", text: "公开仓库包含完整的双语界面、广告位系统和 Cloudflare 后端方案。Fork 之后替换产品图、文案与价格，配置自己的服务即可上线。", button: "在 GitHub 上 Fork", secondary: "查看部署说明", steps: [["Fork","把公开仓库复制到你的账号。"],["改成你的版本","替换设备、广告位、活动文案和价格。"],["部署上线","连接你的 Cloudflare 资源与付款配置。"]] },
    globe: { eyebrow: "实时访客", title: "看看此刻谁正在这里。", lead: "拖动、缩放地球，查看近期访客所在国家、城市和进入渠道。页面打开期间，第一方数据会持续更新。", loading: "正在载入实时访客…", live: "实时访客数据", retry: "重新连接访客数据", events: "位近期访客", selected: "近期访客", opens: "累计访客", liveNow: "人在线", instruction: "拖动 · 缩放 · 选择访客", source: "Cloudflare 位置 · 第一方统计", unknown: "位置暂不可用", direct: "直接访问" },
    footer: { hi: "由 @sergepoliakov 设计与开发", bio: "一个开源活动：把一块实体表面变成十个有限、可验证的媒体位置。", prompt: "想做自己的版本？", join: "Fork 开源项目。", privacy: "隐私说明", terms: "竞拍条款", source: "开源代码", legal: "独立活动，不主张任何关联、背书或赞助关系。第三方商标归各自权利方所有。" },
    modal: {
    ...
    legal: {
      ...
      privacySections: [["竞拍资料","我们处理邮箱、品牌名称、选填的网站和 X 账号、所选广告位、出价金额、付款网络及交易标识。"],["品牌图稿","PNG、JPG 和 WEBP 图稿保存在私有对象存储中，经审核后才会公开显示。未通过审核的图稿不会公开。"],["访客数据","实时访客功能保存匿名浏览器会话、Cloudflare 提供的大致国家、地区与城市、进入渠道，以及首次和最近访问时间；不会保存访客原始 IP 地址。"],["区块链记录","钱包地址、代币转账和交易标识属于公开链上数据；系统会用它们核对付款网络、代币和付款信息。"],["服务提供方","Cloudflare 提供托管、数据库、对象存储、大致请求位置、防滥用与日志能力；MapLibre 与 OpenFreeMap 用于渲染交互式地球。"],["开源版本","正式接口不可用时，本地预览出价仅保存在浏览器中，不会提交至实时竞拍。"]],
