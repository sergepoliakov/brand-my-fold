...
export const COPY = {
  en: {
    ...
    hero: {
      ...
      raised: "in leading bids", goal: "of the phone target", ends: "Auction closes in", unfolded: "Open view", folded: "Folded view", auctionLayer: "Auction map", finalLayer: "Final look",
      hint: "Choose the physical form, then switch between measured auction zones and the finished sticker view. Every spot keeps the same ID in every state.",
    ...
    waitlist: { eyebrow: "FOLLOW THE LAUNCH", title: "Get the auction-opening note", text: "Join once. You will receive the launch notice and essential campaign updates only.", email: "Email", handle: "X handle (optional)", button: "Join the waitlist", local: "Your email is used only for campaign updates described in the privacy notice.", localDemo: "This open-source demo stores the entry only in this browser.", done: "You’re on the list.", doneSub: "Your entry has been received.", doneDemo: "Saved in this browser for the open-source demo.", error: "Please try again." },
  ...
  zh: {
    ...
    hero: {
      visitors: "次访问", title: "把你的品牌，贴上我的 Fold。", subtitle: `未来这台${productZh}的摄像头侧外壳，只有十个经过测量的广告位。`, raised: "当前领先出价", goal: "手机目标已完成", ends: "竞拍剩余", unfolded: "展开效果", folded: "折叠效果", auctionLayer: "竞拍位展示", finalLayer: "实际效果",
      hint: "先选择展开或折叠形态，再切换竞拍位展示与贴纸实际效果；同一编号始终对应同一块物理位置。", printable: "摄像头侧外壳", screen: "外屏 · 不设广告位", bid: "出价", outbid: "加价", story: `十张贴纸，十四天，一台走进真实生活的${productZh}。`, story2: "获胜品牌购买的是一个有限的实体广告位、本页品牌链接，以及活动首发和日常使用内容中的公开呈现。这里不承诺曝光量、点击量或投资回报。", howLink: "了解参与方式",
    },
    ...
    waitlist: { eyebrow: "关注正式上线", title: "竞拍开放时通知我", text: "只需登记一次，我们只发送开拍通知和必要的活动更新。", email: "邮箱", handle: "X 账号（选填）", button: "加入等候名单", local: "你的邮箱仅用于隐私说明中列明的活动通知。", localDemo: "开源演示只把记录保存在当前浏览器中。", done: "登记成功。", doneSub: "我们已经收到你的信息。", doneDemo: "记录已保存在当前浏览器中。", error: "提交失败，请稍后重试。" },
