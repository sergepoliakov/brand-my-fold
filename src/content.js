...
export const COPY = {
  en: {
    ...
    faq: { eyebrow: "DETAILS", title: "Questions & Answers", items: [
      ...
      waitlist: { eyebrow: "FOLLOW THE LAUNCH", title: "Get the auction-opening note", text: "Join once. You will receive the launch notice and essential campaign updates only.", email: "Email", handle: "X handle (optional)", button: "Join the waitlist", local: "Your email is used only for campaign updates described in the privacy notice.", localDemo: "This open-source demo stores the entry only in this browser.", unavailable: "The production service is temporarily unavailable. No entry has been recorded.", done: "You’re on the list.", doneSub: "Your entry has been received.", doneDemo: "Saved in this browser for the open-source demo.", error: "Please try again." },
  ...
  zh: {
    ...
    waitlist: { eyebrow: "关注正式上线", title: "竞拍开放时通知我", text: "只需登记一次，我们只发送开拍通知和必要的活动更新。", email: "邮箱", handle: "X 账号（选填）", button: "加入等候名单", local: "你的邮箱仅用于隐私说明中列明的活动通知。", localDemo: "开源演示只把记录保存在当前浏览器中。", unavailable: "正式服务暂时不可用，本次信息尚未登记。", done: "登记成功。", doneSub: "我们已经收到你的信息。", doneDemo: "记录已保存在当前浏览器中。", error: "提交失败，请稍后重试。" },
