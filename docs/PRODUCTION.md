...
7. Apply D1 migrations, deploy, and test health, config, anonymous visitor heartbeat, traffic aggregation, quote, upload, verification, moderation, WebSocket and refund-queue paths.
